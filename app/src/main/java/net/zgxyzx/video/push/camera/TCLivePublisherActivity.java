package net.zgxyzx.video.push.camera;
...
import net.zgxyzx.video.common.widget.TCInputTextMsgDialog;
import net.zgxyzx.video.common.widget.TCSwipeAnimationController;
import net.zgxyzx.video.common.widget.beautysetting.BeautyDialogFragment;
import net.zgxyzx.video.common.widget.danmaku.TCDanmuMgr;
import net.zgxyzx.video.common.widget.like.TCHeartLayout;
import net.zgxyzx.video.im.TCChatEntity;
import net.zgxyzx.video.im.TCChatMsgListAdapter;
import net.zgxyzx.video.im.TCChatRoomMgr;
import net.zgxyzx.video.im.TCSimpleUserInfo;
import net.zgxyzx.video.push.DetailDialogFragment;
import net.zgxyzx.video.push.TCPusherMgr;
import net.zgxyzx.video.push.camera.widget.TCAudioControl;
...
//        mUserAvatarList.setAdapter(mAvatarListAdapter);
        ...
        if (!TextUtils.isEmpty(LoginUtils.getUserInfo().data.headpic)) {
            showHeadIcon(mHeadIcon,LoginUtils.getUserInfo().data.headpic);
        }else {
        ...
        if (event < 0) {
            if (event == TXLiveConstants.PUSH_ERR_NET_DISCONNECT) {//网络断开，弹对话框强提醒，推流过程中直播中断需要显示直播信息后退出
               if (NetworkUtils.isConnected()) {
                   showComfirmDialog(TCConstants.ERROR_MSG_LIVE_STOPPED, true);
               }else{
