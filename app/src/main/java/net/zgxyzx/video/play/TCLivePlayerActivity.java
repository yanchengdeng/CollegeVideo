...
import net.zgxyzx.video.common.utils.TCFrequeControl;
...
import net.zgxyzx.video.common.widget.TCUserAvatarListAdapter;
...
//        mCurrentMemberCount = Long.decode(intent.getStringExtra(TCConstants.MEMBER_COUNT));
        ...
        findViewById(R.id.btn_vod_share).setVisibility(View.GONE);
        findViewById(R.id.btn_log).setVisibility(View.GONE);
        findViewById(R.id.btn_vod_log).setVisibility(View.GONE);
        initView();
...
//                joinRoom();
    ...
    protected void showLog() {
        ...
        liveLog.setVisibility(View.INVISIBLE);
        vodLog.setVisibility(View.INVISIBLE);
        if (mShowLog) {
