package net.zgxyzx.video.common.utils;
...
public class TCConstants {
    ...
    //云通信服务相关配置
    public static final int IMSDK_ACCOUNT_TYPE = 15419;
    public static final int IMSDK_APPID = 1400043491;

    //COS存储服务相关配置
    public static final String COS_BUCKET = "ddxx123456";
    public static final String COS_APPID  = "1252472859";
    ...
    //业务Server的Http配置
    public static final String SVR_POST_URL = "http://live.api.dadaodata.com/";
    ...
    //小直播appid
    public static final int XIAOZHIBO_APPID = 1400042818;


    //bugly组件Appid，bugly为腾讯提供的用于App Crash收集和分析的组件
    public static final String BUGLY_APPID = "i1400040621";
    //**********************************************************************
    ...
    // UGCEditer
    public static final String ACTION_UGC_SINGLE_CHOOSE  = "net.zgxyzx.video.single";
    public static final String ACTION_UGC_MULTI_CHOOSE   = "net.zgxyzx.video.multi";
